...
SECRET_KEY = 'django-insecure-1br)=0@ovl&0o5h5@#v_#x$1b-marrufw9(&u%v&&4*=iid0nv'
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'templates'], #conectamos nuestra carpeta templates
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
